...
namespace ShoppingCart.Test.Controller.V1
{
    public class ShoppingCartControllerTests : ControllerTestsBase
    {
        ...
        public virtual async Task ChangeQuantity_ShoppingCartItemById()
        {
            ...
            var shoppingCartChangeItemQuantityContent = new StringContent(JsonConvert.SerializeObject(addRequest), System.Text.Encoding.UTF8, "application/json");
            httpResponse = await Client.PostAsync($"/api/{Version}/shoppingcart/{shoppingCart.Id}/change-item-quantity", shoppingCartChangeItemQuantityContent);
